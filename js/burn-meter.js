/* MONWOLF Burn Meter — polls Monad RPC for $MONWOLF balance at the dead address.
...
(function(){
  var TOKEN  = '0x8361a59d340466211ad4aB41C09a32e4530a7777';
  ...
  window.MonWolfBurnMeter = { refresh: tick, fetch: fetchBurn };
...
// Back-compat alias
if (window.MonWolfBurnMeter && !window.ChogiBurnMeter){ window.ChogiBurnMeter = window.MonWolfBurnMeter; }
